...
class Crop:
    ...
    def set_data(self):
        ...
        if GlossaryCore.ConstructionDelay in self.techno_infos_dict:
            ...
            print("The construction_delay data is not set for Crop : default = 3 years  ")
    ...
    def compute_aging_distribution_production(self):
        ...
        aging_distrib_year_df["distrib_prod (TWh)"] = (
        ...
        prod_array = aging_distrib_year_df["distrib_prod (TWh)"].values.tolist() * len_years
    ...
    def compute_dprod_from_dinvest(self):
        ...
        for i in range(nb_years):
            ...
            # 0,0,0]
            dpprod_dpinvest = 1 / self.cost_details["Capex ($/MWh)"].values[i] / self.data_fuel_dict["calorific_value"]
