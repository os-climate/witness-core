...
class Design_Var_Discipline(SoSDiscipline):
    ...
    DESC_OUT = {
        #         'share_energy_investment': {'type': 'dataframe', 'dataframe_descriptor': {'years': ('float', None, False),
        #                                                                                   'share_investment': ('float', None, True)}, 'dataframe_edition_locked': False, 'visibility': SoSDiscipline.SHARED_VISIBILITY, 'namespace': 'ns_witness'},
