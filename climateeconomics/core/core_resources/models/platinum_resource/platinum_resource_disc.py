...
class PlatinumResourceDiscipline(ResourceDiscipline):
    ...
    default_world_consumption_dict = {
        "exhaust_treatment_system": 0.00008064,
        "jewelry": 0.00005824,
    ...
    DESC_IN = {
        ...
        "production_start": {
            "type": "int",
            "default": default_regression_start,
            "unit": "-",
        ...
        "regression_stop": {
            "type": "int",
            "default": default_regression_stop,
            "unit": "-",
            "visibility": SoSWrapp.SHARED_VISIBILITY,
            "namespace": "ns_platinum_resource",
        },
        "world_consumption": {
            ...
            "unit": "-",
            "default": default_world_consumption_dict,
            "visibility": SoSWrapp.SHARED_VISIBILITY,
            "user_level": 2,
            "namespace": "ns_platinum_resource",
        },
    ...
    DESC_OUT = {
        ...
        "recycled_production": {"type": "dataframe", "unit": prod_unit},
    }
    ...
    def get_stock_charts(self, stock_df, use_stock_df):
        ...
        stock_chart = TwoAxesInstanciatedChart(
            "Years", "maximum stocks [t]", chart_name=f"{self.resource_name} stocks through the years", stacked_bar=True
        )
        if len(sub_resource_list) > 1:
            use_stock_chart = TwoAxesInstanciatedChart(
                "Years",
                f"{self.resource_name} use [t]",
        ...
        for sub_resource_type in sub_resource_list:
            stock_serie = InstanciatedSeries(
                ...
                (stock_df[sub_resource_type] * 1000 * 1000).values.tolist(),
                sub_resource_type,
            ...
            use_stock_serie = InstanciatedSeries(
                ...
                (use_stock_df[sub_resource_type] * 1000 * 1000).values.tolist(),
                sub_resource_type,
    ...
    def get_production_charts(self, production_df, past_production_df, year_start, production_start):
        ...
        if len(sub_resource_list) > 1:
            production_chart = TwoAxesInstanciatedChart(
                "Years",
                f"{self.resource_name} production per subtypes [t]",
        ...
        production_cumulated_chart = TwoAxesInstanciatedChart(
            "Years",
            f"{self.resource_name} production [t]",
        ...
        for sub_resource_type in sub_resource_list:
            production_serie = InstanciatedSeries(
                ...
                (production_df[sub_resource_type] * 1000 * 1000).values.tolist(),
                sub_resource_type,
                InstanciatedSeries.BAR_DISPLAY,
            )
            if len(sub_resource_list) > 1:
            ...
            production_cut_series = InstanciatedSeries(
                list(production_df[GlossaryCore.Years]),
                (production_cut[sub_resource_type] * 1000 * 1000).values.tolist(),
            ...
            past_production_series = InstanciatedSeries(
                ...
                (past_production_df[sub_resource_type] * 1000 * 1000).values.tolist(),
                sub_resource_type,
                InstanciatedSeries.LINES_DISPLAY,
            )
            past_production_cut_series = InstanciatedSeries(
                list(production_df[GlossaryCore.Years]),
                (past_production_cut[sub_resource_type] * 1000 * 1000).values.tolist(),
    ...
    def get_recycling_charts(self, recycling_df, use_stock_df):
        recycling_chart = TwoAxesInstanciatedChart(
            "Years",
            f"{self.resource_name} recycling and used stock [t]",
        ...
        for sub_resource_type in sub_resource_list:
            recycling_serie = InstanciatedSeries(
                ...
                (recycling_df[sub_resource_type] * 1000 * 1000).values.tolist(),
