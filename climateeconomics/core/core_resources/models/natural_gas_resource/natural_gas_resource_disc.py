...
class NaturalGasResourceDiscipline(ResourceDiscipline):
    ...
    DESC_OUT = {
        'resource_stock': {'type': 'dataframe', 'unit': 'bcm', },
        'resource_price': {'type': 'dataframe', 'unit': '$/MMBTU', },
        'use_stock': {'type': 'dataframe', 'unit': 'bcm', },
        'predictable_production': {'type': 'dataframe', 'unit': 'bcm',},
        'recycled_production' : {
            'type': 'dataframe', 'unit': 'bcm'}
    }
