...
class MacroEconomics():
    ...
    def set_data(self):
        ...
        self.invest_co2_tax_in_renawables = self.param['climate_effects_activation_dict']['invest_co2_tax_in_renewables'] if self.param['climate_effects_activation_dict']['all_effects'] else False
