...
class PolicyModel:
    ...
    def compute_smax(self, param):
        ...
        self.ccs_price_percentage = param["ccs_price_percentage"] / 100.0
        self.co2_damage_price_percentage = param["co2_damage_price_percentage"] / 100.0
        self.CO2_tax[GlossaryCore.Years] = self.CO2_damage_price[GlossaryCore.Years].values
        CO2_damage_price_array = (
            self.co2_damage_price_percentage * self.CO2_damage_price[GlossaryCore.CO2DamagePrice].values
        )
