...
class IndustrialDiscipline(ClimateEcoDiscipline):
    ...
    DESC_IN = {
        ...
        'energy_eff_k':  {'type': 'float', 'default': 0.026986, 'user_level': 3, 'unit': '-'},
        'energy_eff_cst': {'type': 'float', 'default': 0.171694, 'user_level': 3, 'unit': '-'},
        'energy_eff_xzero': {'type': 'float', 'default': 2015, 'user_level': 3, 'unit': '-'},
        'energy_eff_max': {'type': 'float', 'default': 3.1562276, 'user_level': 3, 'unit': '-'},
        # Production function param
        'output_alpha': {'type': 'float', 'default': 0.909985, 'user_level': 2, 'unit': '-'},
