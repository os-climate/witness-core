...
class LaborMarketDiscipline(ClimateEcoDiscipline):
    ...
    def setup_sos_disciplines(self):
        ...
        if self.get_data_in() is not None:
            if GlossaryCore.SectorListValue in self.get_data_in():
                ...
                df_descriptor.update({col: ("float", None, True) for col in sector_list})

                dynamic_inputs["workforce_share_per_sector"] = {
                    "type": "dataframe",
                    "unit": "%",
    ...
    def run(self):
        ...
        outputs_dict = {GlossaryCore.WorkforceDfValue: workforce_df, "employment_df": employment_df}
    ...
    def compute_sos_jacobian(self):
        ...
        for sector in sector_list:
            ...
            self.set_partial_derivative_for_other_types(
                (GlossaryCore.WorkforceDfValue, sector),
                (GlossaryCore.WorkingAgePopulationDfValue, GlossaryCore.Population1570),
    ...
    def get_post_processing_list(self, chart_filters=None):
        ...
        if "total workforce" in chart_list:
            ...
            min_value, max_value = self.get_greataxisrange(working_age_pop_df[GlossaryCore.Population1570])
        ...
        if "workforce per sector" in chart_list:
            ...
            new_chart = TwoAxesInstanciatedChart(
                GlossaryCore.Years,
                "Workforce per sector [million of people]",
                [year_start - 5, year_end + 5],
            ...
            for sector in sector_list:
                ...
                new_series = InstanciatedSeries(years, ordonate_data, f"{sector} workforce", "lines", visible_line)
                new_chart.series.append(new_series)
        ...
        if "workforce share per sector" in chart_list:
            ...
            for sector in sector_list:
                ...
                new_series = InstanciatedSeries(
                    years, ordonate_data, f"{sector} share of total workforce", "bar", visible_line
                )
                new_chart.series.append(new_series)
