...
class AgricultureDiscipline(SoSWrapp):
    ...
    def get_post_processing_list(self, chart_filters=None):
        ...
        if AgricultureDiscipline.AGRICULTURE_CHARTS in chart_list:
            ...
            years_start = AgricultureDiscipline._get_sosdisc_inputs(self)['year_start']
            years_end = AgricultureDiscipline._get_sosdisc_inputs(self)['year_end']
            time_step = AgricultureDiscipline._get_sosdisc_inputs(self)['time_step']
