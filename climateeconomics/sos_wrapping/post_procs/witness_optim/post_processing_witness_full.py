...
Modifications on 2024/07/12, 2025/06/12 Copyright 2025 Capgemini
    ...
    for energy in energy_list:
        ...
        for techno in techno_list:
            ...
            production_techno = techno_disc.get_sosdisc_outputs(
                'techno_production')[energy].values  # * 1e3  # TODO: check if scaling required
            ...
            CO2_per_kWh_techno = techno_disc.get_sosdisc_outputs('techno_scope_1_emissions')[
                'CO2'].values
...
#
#     # Prepare data
#     columns = ['energy', 'technology', 'production',
#                'CO2_per_use']
