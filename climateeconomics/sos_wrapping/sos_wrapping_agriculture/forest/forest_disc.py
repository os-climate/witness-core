...
class ForestDiscipline(ClimateEcoDiscipline):
    ...
    plantation_forest_surface_mha_2020 = 131.0
    plantation_forest_supply_Mm3_2020 = 654.0
    ...
    unmanaged_yield = (
        (total_wood_production_2020 - plantation_forest_supply_Mm3_2020)
        * 1e6
        / (wood_production_surface * 1e9 - plantation_forest_surface_mha_2020 * 1e6)
    )  # 3.19 m3/ha
    ...
    wood_techno_dict = {
        ...
        "managed_wood_price_per_ha": 3500.0,
    ...
    DESC_IN = {
        ...
        Forest.DEFORESTATION_INVESTMENT: {
            "type": "dataframe",
            "unit": "G$",
        ...
        Forest.DEFORESTATION_COST_PER_HA: {"type": "float", "unit": "$/ha", "default": 8000, "namespace": "ns_forest"},
        ...
        Forest.MW_INITIAL_SURFACE: {
            "type": "float",
            "unit": "Gha",
            "default": wood_production_surface,
            "namespace": "ns_forest",
        },
        Forest.MW_INVEST_BEFORE_YEAR_START: {
            "type": "dataframe",
            "unit": "G$",
            "dataframe_descriptor": {
                "past_years": ("float", None, False),
                GlossaryCore.InvestmentsValue: ("float", [0, 1e9], True),
            },
            "dataframe_edition_locked": False,
        ...
        Forest.MARGIN: {
            ...
            "namespace": GlossaryCore.NS_WITNESS,
            "visibility": ClimateEcoDiscipline.SHARED_VISIBILITY,
            "dataframe_descriptor": {GlossaryCore.Years: ("float", None, False), "margin": ("float", [0, 1e9], True)},
            "dataframe_edition_locked": False,
        },
        Forest.UNMANAGED_FOREST: {
            "type": "float",
            "unit": "Gha",
            "default": initial_unmanaged_forest_surface,
            "namespace": "ns_forest",
        },
        Forest.PROTECTED_FOREST: {
            "type": "float",
            "unit": "Gha",
            "default": initial_protected_forest_surface,
            "namespace": "ns_forest",
        },
    ...
    DESC_OUT = {
        Forest.CO2_EMITTED_DETAIL_DF: {"type": "dataframe", "unit": "GtCO2", "namespace": "ns_forest"},
        ...
        Forest.MW_DF: {"type": "dataframe", "unit": "Gha", "namespace": "ns_forest"},
        Forest.BIOMASS_DRY_DETAIL_DF: {"type": "dataframe", "unit": "-", "namespace": "ns_forest"},
        "techno_production": {
            "type": "dataframe",
            "unit": "TWh or Mt",
            "visibility": ClimateEcoDiscipline.SHARED_VISIBILITY,
    ...
    def run(self):
        ...
        techno_production = self.forest_model.techno_production[[GlossaryCore.Years, "biomass_dry (TWh)"]]
        for column in techno_production.columns:
            if column == GlossaryCore.Years:
                continue
            techno_production[column] = (
                techno_production[column].values / inputs_dict["scaling_factor_techno_production"]
            )
        ...
        for column in techno_consumption.columns:
            ...
            techno_consumption[column] = (
                techno_consumption[column].values / inputs_dict["scaling_factor_techno_consumption"]
            )
            techno_consumption_woratio[column] = (
                techno_consumption_woratio[column].values / inputs_dict["scaling_factor_techno_consumption"]
            )
    ...
    def compute_sos_jacobian(self):
        ...
        (
            d_cum_umw_d_deforestation_invest,
        ...
        ) = self.forest_model.compute_d_limit_surfaces_d_deforestation_invest(d_deforestation_surface_d_invest)
        (
        ...
        ) = self.forest_model.compute_d_limit_surfaces_d_reforestation_invest(d_reforestation_surface_d_invest)
        (
            d_cum_umw_d_mw_invest,
            d_delta_mw_d_mw_invest,
            d_delta_deforestation_d_mw_invest,
            d_lc_deforestation_d_mw_invest,
            d_lc_reforestation_d_mw_invest,
            d_lc_mw_d_mw_invest,
        ) = self.forest_model.compute_d_limit_surfaces_d_mw_invest(d_mw_surface_d_invest)
        ...
        self.set_partial_derivative_for_other_types(
            (Forest.FOREST_SURFACE_DF, "forest_constraint_evolution"),
            (Forest.DEFORESTATION_INVESTMENT, GlossaryCore.InvestmentsValue),
        ...
        self.set_partial_derivative_for_other_types(
            ...
            (Forest.DEFORESTATION_INVESTMENT, GlossaryCore.InvestmentsValue),
            d_CO2_land_emission_d_deforestation_invest,
        )
        ...
        self.set_partial_derivative_for_other_types(
            ("CO2_land_emission_df", "emitted_CO2_evol_cumulative"),
            (Forest.REFORESTATION_INVESTMENT, "forest_investment"),
            d_CO2_land_emission_d_reforestation_invest,
        )
        ...
        self.set_partial_derivative_for_other_types(
            ("CO2_land_emission_df", "emitted_CO2_evol_cumulative"),
            ("managed_wood_investment", GlossaryCore.InvestmentsValue),
            d_CO2_land_emission_d_mw_invest,
        )
    ...
    def get_post_processing_list(self, chart_filters=None):
        ...
        if ForestDiscipline.FOREST_CHARTS in chart_list:
            ...
            new_chart = TwoAxesInstanciatedChart(
                GlossaryCore.Years, "Investments [G$]", chart_name="Investments in forests activities", stacked_bar=True
            )
            ...
            deforested_series = InstanciatedSeries(years, delta_deforestation.tolist(), "Deforestation", "bar")
            forested_series = InstanciatedSeries(years, delta_reforestation.tolist(), "Reforestation", "bar")
            total_series = InstanciatedSeries(
                years, delta_global.tolist(), "Global forest surface", InstanciatedSeries.LINES_DISPLAY
            )
            managed_wood_series = InstanciatedSeries(years, delta_managed_wood_surface.tolist(), "Managed wood", "bar")
            ...
            new_chart = TwoAxesInstanciatedChart(
                GlossaryCore.Years,
                "Forest surface evolution [Mha]",
                chart_name="Global forest surface evolution",
                stacked_bar=True,
            )

            deforested_series = InstanciatedSeries(years, deforestation.tolist(), "Deforested surface", "bar")
            forested_series = InstanciatedSeries(years, reforestation.tolist(), "Reforested surface", "bar")
            total_series = InstanciatedSeries(
                years, global_surface.tolist(), "Forest surface evolution", InstanciatedSeries.LINES_DISPLAY
            )
            managed_wood_series = InstanciatedSeries(years, managed_wood_surface.tolist(), "Managed wood", "bar")
            unmanaged_forest_series = InstanciatedSeries(years, unmanaged_forest.tolist(), "Unmanaged forest", "bar")
            protected_forest_series = InstanciatedSeries(years, protected_forest.tolist(), "Protected forest", "bar")
            ...
            mw_residues_energy_twh = (
                managed_wood_df["residues_production_for_energy (Mt)"] * ForestDiscipline.biomass_cal_val
            )
            ...
            new_chart = TwoAxesInstanciatedChart(
                GlossaryCore.Years,
                "Biomass dry [Mt]",
                chart_name="Break down of biomass dry production",
                stacked_bar=True,
            )
            ...
            new_chart = TwoAxesInstanciatedChart(
                GlossaryCore.Years, "Price [$/MWh]", chart_name="Biomass dry price evolution", stacked_bar=True
            )
            ...
            new_chart = TwoAxesInstanciatedChart(
                GlossaryCore.Years, "Price [$/ton]", chart_name="Biomass dry price evolution", stacked_bar=True
            )
            ...
            new_chart = TwoAxesInstanciatedChart(
                GlossaryCore.Years, "Capital [G$]", chart_name="Lost capital due to deforestation", stacked_bar=True
            )
