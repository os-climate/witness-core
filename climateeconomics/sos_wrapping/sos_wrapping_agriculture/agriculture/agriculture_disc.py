...
class AgricultureDiscipline(ClimateEcoDiscipline):
    ...
    DESC_IN = {
        ...
        "red_meat_percentage": {
            "type": "dataframe",
            "default": default_red_meat_percentage,
            "dataframe_descriptor": {
        ...
        "white_meat_percentage": {
            "type": "dataframe",
            "default": default_white_meat_percentage,
            "dataframe_descriptor": {
                GlossaryCore.Years: ("float", None, False),
        ...
        "other_use_agriculture": {
            "type": "array",
            "unit": "ha/person",
            "default": default_other_use,
            "namespace": "ns_agriculture",
        },
    ...
    def get_chart_filter_list(self):
        ...
        chart_list = [AgricultureDiscipline.AGRICULTURE_CHARTS, "Agriculture Productivity Evolution"]
        ...
        if AgricultureDiscipline.AGRICULTURE_CHARTS in chart_list:
            ...
            for key in updated_diet_df.keys():
                ...
                if key == GlossaryCore.Years:
                    ...
                    new_series = InstanciatedSeries(
                        years,
                        (updated_diet_df[key].values * kg_to_kcal_dict[key]).tolist(),
                        key,
            ...
            new_chart = TwoAxesInstanciatedChart(
                GlossaryCore.Years,
                "food calories [kcal / person / year]",
                chart_name="Evolution of the diet over time",
                stacked_bar=True,
            )
            ...
            for key in updated_diet_df.keys():
                ...
                if key == GlossaryCore.Years:
                    ...
                    new_series = InstanciatedSeries(
                        years,
                        (updated_diet_df[key].values * kg_to_kcal_dict[key] * 100 / total_kcal).tolist(),
                        key,
                        InstanciatedSeries.BAR_DISPLAY,
                    )
            ...
            new_chart = TwoAxesInstanciatedChart(
                GlossaryCore.Years,
                "food calories proportion [% / person / year]",
                chart_name="Evolution of the diet proportion over time",
                stacked_bar=True,
            )
            # add a fake serie of value before the other serie to keep the same color than in the first graph,
            # where the line plot of total surface take the first color
            ...
            new_chart = TwoAxesInstanciatedChart(GlossaryCore.Years, "Diet evolution [%]", chart_name=chart_name)
