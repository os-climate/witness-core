...
class CropDiscipline(ClimateEcoDiscipline):
    ...
    def run(self):
        ...
        self.crop_model.red_to_white_meat = inp_dict[Crop.RED_TO_WHITE_MEAT]
        self.crop_model.meat_to_vegetables = inp_dict[Crop.MEAT_TO_VEGETABLES]
        #-- compute
    ...
    def get_chart_filter_list(self):
        ...
        chart_list = [
            CropDiscipline.CROP_CHARTS, 'Crop Productivity Evolution']
