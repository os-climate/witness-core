...
_oil_gas = {FILE_NAME: 'oil_gas_fraction.csv', UNIT_CONV_FACTOR: 1.0,
            WITNESS_VARS_COLS: [('EnergyMix.methane.energy_production_detailed', 'methane FossilGas (TWh)'),
                                # ('EnergyMix.fuel_production.energy_production_detailed', 'fuel_production.biodiesel Transesterification (TWh)'),
                                # ('EnergyMix.fuel_production.energy_production_detailed', 'fuel_production.ethanol BiomassFermentation (TWh)'),
                                ('EnergyMix.fuel_production.energy_production_detailed', 'fuel_production.hydrotreated_oil_fuel HefaDecarboxylation (TWh)'),
                                ('EnergyMix.fuel_production.energy_production_detailed', 'fuel_production.hydrotreated_oil_fuel HefaDeoxygenation (TWh)'),
                                ('EnergyMix.fuel_production.energy_production_detailed', 'fuel_production.liquid_fuel FischerTropsch (TWh)'),
                                ('EnergyMix.fuel_production.energy_production_detailed', 'fuel_production.liquid_fuel Refinery (TWh)'),
