...
class MacroeconomicsDiscipline(ClimateEcoDiscipline):
    ...
    DESC_IN = {
        ...
        'population_df': {'type': 'dataframe', 'unit': 'millions of people',
                          'dataframe_descriptor': {'years': ('float', None, False),
                                                   'population': ('float', [0, 1e9], True)}, 'dataframe_edition_locked': False, 'visibility': 'Shared', 'namespace': 'ns_witness'},
    ...
    DESC_OUT = {
        ...
        'energy_investment_macro': {'type': 'dataframe', 'visibility': 'Shared', 'unit': 'G$', 'namespace': 'ns_witness'},
    ...
    def run(self):
        ...
        dict_values = {'economics_detail_df': economics_df,
                       'economics_df': economics_df[['years', 'gross_output', 'pc_consumption']],
                       'energy_investment_macro': energy_investment,
    ...
    def compute_sos_jacobian(self):
        ...
        self.set_partial_derivative_for_other_types(
            ('energy_investment_macro', 'energy_investment'), ('damage_df', 'damage_frac_output'), denergy_investment * 1e3)  # Invest from T$ to G$
        ...
        self.set_partial_derivative_for_other_types(
            ('energy_investment_macro', 'energy_investment'), ('energy_production', 'Total production'), scaling_factor_energy_production * denergy_investment * 1e3)  # Invest from T$ to G$
        ...
        self.set_partial_derivative_for_other_types(
            ('energy_investment_macro', 'energy_investment'), ('share_energy_investment', 'share_investment'), denergy_investment * 1e3 / 100.0)  # Invest from T$ to G$
        ...
        self.set_partial_derivative_for_other_types(
            ('energy_investment_macro', 'energy_investment'), ('total_investment_share_of_gdp', 'share_investment'), denergy_investment * 1e3 / 100.0)  # Invest from T$ to G$
        ...
        self.set_partial_derivative_for_other_types(
            ('energy_investment_macro', 'energy_investment'), ('co2_emissions_Gt', 'Total CO2 emissions'), denergy_investment * 1e3 / 100.0)  # Invest from T$ to G$
        ...
        self.set_partial_derivative_for_other_types(
            ('energy_investment_macro', 'energy_investment'), ('CO2_taxes', 'CO2_tax'), denergy_investment * 1e3 / 100.0)  # Invest from T$ to G$
