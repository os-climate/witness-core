...
class TempChangeDiscipline(ClimateEcoDiscipline):
    ...
    DESC_IN = {
        ...
        "forcing_model": {
            "type": "string",
            "default": "Meinshausen",
            "possible_values": ["DICE", "Myhre", "Etminan", "Meinshausen"],
            "structuring": True,
        },
    ...
    def compute_sos_jacobian(self):
        ...
        for forcing_name, d_forcing_datmo_conc in self.model.d_forcing_datmo_conc_dict.items():
            self.set_partial_derivative_for_other_types(
                ("forcing_detail_df", forcing_name),
                (GlossaryCore.CarbonCycleDfValue, "atmo_conc"),
                np.identity(len(d_forcing_datmo_conc)) * d_forcing_datmo_conc,
            )
        ...
        self.set_partial_derivative_for_other_types(
            ("temperature_objective",),
            (GlossaryCore.CarbonCycleDfValue, "atmo_conc"),
            d_tempatmoobj_d_temp_atmo.dot(d_tempatmo_d_atmoconc),
        )
    ...
    def get_post_processing_list(self, chart_filters=None):
        ...
        if "temperature evolution" in chart_list:
            ...
            min_values = {}
            for key in to_plot:
                min_values[key], max_values[key] = self.get_greataxisrange(temperature_df[to_plot])
