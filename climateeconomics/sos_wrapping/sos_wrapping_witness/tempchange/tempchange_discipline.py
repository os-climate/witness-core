...
class TempChangeDiscipline(ClimateEcoDiscipline):
    ...
    DESC_IN = {
        ...
        'init_temp_ocean': {'type': 'float', 'default': DatabaseWitnessCore.OceanWarmingAnomalySincePreindustrial.get_value_at_year(GlossaryCore.YearStartDefault), 'user_level': 2, 'unit': '°C'},
