...
### Population
Depending on witness version process, population is whether a static population forecast dataframe from GHDx[^8] in million of persons or a dataframe coming from population model.
