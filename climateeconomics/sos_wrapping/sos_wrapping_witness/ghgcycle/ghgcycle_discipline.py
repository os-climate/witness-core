...
class GHGCycleDiscipline(ClimateEcoDiscipline):
    ...
    DESC_IN = {
        ...
        'co2_emissions_fractions': {'type': 'list', 'unit': '-', 'default': [0.13, 0.20, 0.32, 0.25, 0.10], 'user_level': 2},
        'co2_boxes_lifetimes': {'type': 'list', 'unit': 'years', 'default': [np.inf, 363, 74, 17, 2], 'user_level': 2},
