...
class GHGCycleDiscipline(ClimateEcoDiscipline):
    ...
    def init_execution(self):
        ...
        self.carboncycle = GHGCycle(param_in)
    ...
    def compute_sos_jacobian(self):
        ...
        carboncycle_df
          - 'atmo_conc':
                - GHG_emissions_df, 'Total CO2 emissions'
          - 'lower_ocean_conc':
                - GHG_emissions_df, 'Total CO2 emissions'
          - 'shallow_ocean_conc':
                - GHG_emissions_df, 'Total CO2 emissions'
        ...
        self.set_partial_derivative_for_other_types(
            ('carboncycle_df', 'atmo_conc'), ('GHG_emissions_df', 'Total CO2 emissions'),  d_atmoconc_d_totalemissions)
        ...
        self.set_partial_derivative_for_other_types(
            ('rockstrom_limit_constraint', ), ('GHG_emissions_df', 'Total CO2 emissions'),  -d_ppm_d_totalemissions / self.carboncycle.rockstrom_constraint_ref)
        self.set_partial_derivative_for_other_types(
            ('minimum_ppm_constraint', ), ('GHG_emissions_df', 'Total CO2 emissions'),  d_ppm_d_totalemissions / self.carboncycle.minimum_ppm_constraint_ref)
