...
class GHGCycleDiscipline(ClimateEcoDiscipline):
    ...
    DESC_IN = {
        ...
        'ch4_init_conc': {'type': 'float', 'unit': 'ppb', 'default': DatabaseWitnessCore.CH4YearStartConcentration.value, 'user_level': 2},
        ...
        'n2o_init_conc': {'type': 'float', 'unit': 'ppb', 'default': DatabaseWitnessCore.N2OYearStartConcentration.value, 'user_level': 2},
