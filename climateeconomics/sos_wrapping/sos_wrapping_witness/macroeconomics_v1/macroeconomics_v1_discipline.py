...
class MacroeconomicsDiscipline(ClimateEcoDiscipline):
    ...
    def run(self):
        ...
        # Model execution
        economics_df, energy_investment, global_investment_constraint, energy_investment_wo_renewable, pc_consumption_constraint, workforce_df = \
    ...
    def get_chart_filter_list(self):
        ...
        chart_list = ['output of damage', 'gross output and gross output bis',
                      'investment', 'energy_investment', 'population', 'productivity', 
                      'consumption', 'Output growth rate', 'energy supply', 'energy productivity',
