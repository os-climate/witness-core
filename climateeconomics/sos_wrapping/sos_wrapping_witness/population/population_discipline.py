...
class PopulationDiscipline(ClimateEcoDiscipline):
    ...
    DESC_IN = {
        ...
        # 2.2e-2
        'birth_rate_lower': {'type': 'float', 'default': 2.02192894e-02, 'user_level': 3},
        # 1.92403581e-04
        'birth_rate_delta': {'type': 'float', 'default': 6.19058508e-04, 'user_level': 3},
        # 4.03359157e+03
        'birth_rate_phi': {'type': 'float', 'default': 4.03360000e+03, 'user_level': 3},
        # 3.93860555e-01
        'birth_rate_nu': {'type': 'float', 'default': 1.75808789e-01, 'user_level': 3},
