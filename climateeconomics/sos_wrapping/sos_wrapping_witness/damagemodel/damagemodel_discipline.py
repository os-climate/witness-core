...
class DamageDiscipline(ClimateEcoDiscipline):
    ...
    CO2_tax = np.asarray([500.0] * len(years))
    default_CO2_tax = pd.DataFrame({GlossaryCore.Years: years, GlossaryCore.CO2Tax: CO2_tax}, index=years)
    ...
    cheat_variables_dict = {
        ...
        "cheat_var_to_update_ns_regions_in_ms_mdo": {
            "type": "float",
            "namespace": GlossaryCore.NS_REGIONALIZED_POST_PROC,
            "visibility": "Shared",
            "default": 0.0,
            "unit": "-",
            "user_level": 3,
        },
        "cheat_var_to_update_ns_sectorspp_in_ms_mdo1": {
            "type": "float",
        ...
        "cheat_var_to_update_ns_sectorspp_in_ms_mdo2": {
            "type": "float",
        ...
        "cheat_var11": {
            "type": "float",
            "namespace": f"ns_{GlossaryCore.SectorIndustry.lower()}_emissions",
            "visibility": "Shared",
            "default": 0.0,
            "unit": "-",
            "user_level": 3,
        ...
        "cheat_varHOUSE": {
            "type": "float",
            "namespace": f"ns_{GlossaryCore.Households.lower()}_emissions",
            "visibility": "Shared",
            "default": 0.0,
            "unit": "-",
            "user_level": 3,
        ...
        "cheat_var12": {
            "type": "float",
            "namespace": f"ns_{GlossaryCore.SectorServices.lower()}_emissions",
            "visibility": "Shared",
            "default": 0.0,
            "unit": "-",
            "user_level": 3,
        ...
        "cheat_var21": {
            "type": "float",
            "namespace": f"ns_{GlossaryCore.SectorIndustry.lower()}_gdp",
            "visibility": "Shared",
            "default": 0.0,
            "unit": "-",
            "user_level": 3,
        ...
        "cheat_var22": {
            "type": "float",
            "namespace": f"ns_{GlossaryCore.SectorServices.lower()}_gdp",
            "visibility": "Shared",
            "default": 0.0,
            "unit": "-",
            "user_level": 3,
        ...
        "cheat_var23": {
            "type": "float",
            "namespace": f"ns_{GlossaryCore.SectorAgriculture.lower()}_gdp",
            "visibility": "Shared",
            "default": 0.0,
            "unit": "-",
            "user_level": 3,
    ...
    DESC_IN = {
        **cheat_variables_dict,
        ...
        "tp_a3": {"type": "float", "default": 6.081, "user_level": 3, "unit": "-"},
        "tp_a4": {"type": "float", "default": 6.754, "user_level": 3, "unit": "-"},
        "total_emissions_damage_ref": {
            "type": "float",
            "default": 140.0,
            "unit": "Gt",
    ...
    def update_default_with_years(self):
        ...
        if GlossaryCore.YearStart in self.get_data_in():
            ...
            self.set_dynamic_default_values({"damage_constraint_factor": damage_constraint_factor_default})
    ...
    def run(self):
        ...
        # store output data
        out_dict = {
            GlossaryCore.DamageFractionDfValue: damage_fraction_df[
                GlossaryCore.DamageFractionDf["dataframe_descriptor"].keys()
            ],
    ...
    def compute_sos_jacobian(self):
        ...
        if co2_damage_price_dev_formula:
            d_co2_damage_price_d_damages = self.model.d_co2_damage_price_dev_d_user_input(
                d_extra_co2_t_damage_price_d_damages
            )
            d_co2_damage_price_d_extra_co2_ton = self.model.d_co2_damage_price_dev_d_user_input(
                d_extra_co2_t_damage_price_d_extra_co2_ton
            )
    ...
    def get_chart_filter_list(self):
        ...
        chart_list = [GlossaryCore.Damages, "CO2 damage price"]
        co2_damage_price_dev_formula = self.get_sosdisc_inputs("co2_damage_price_dev_formula")
        if co2_damage_price_dev_formula:
    ...
    def get_post_processing_list(self, chart_filters=None):
        ...
        if GlossaryCore.Damages in chart_list:
            ...
            new_series = InstanciatedSeries(
                years,
                list(damage_fraction_df[GlossaryCore.DamageFractionOutput] * 100),
                "Climate damage on GDP",
                "lines",
                True,
            )
        ...
        if "CO2 damage price" in chart_list:
            ...
            co2_damage_price_df = deepcopy(self.get_sosdisc_outputs(GlossaryCore.CO2DamagePrice))
            ...
            new_chart = TwoAxesInstanciatedChart(
                GlossaryCore.Years,
                f'Price ({GlossaryCore.CO2DamagePriceDf["unit"]})',
        ...
        if GlossaryCore.ExtraCO2tDamagePrice in chart_list:
            extra_co2_damage_price_df = deepcopy(self.get_sosdisc_outputs(GlossaryCore.ExtraCO2tDamagePrice))
            ...
            new_chart = TwoAxesInstanciatedChart(
                GlossaryCore.Years,
                f'Price ({GlossaryCore.ExtraCO2tDamagePriceDf["unit"]})',
                chart_name=chart_name,
                y_min_zero=True,
            )
        ...
        if True:
            ...
            new_series = InstanciatedSeries(list(temperature_increase), list(damage_frac), legend, "lines", True)
