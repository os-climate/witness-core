...
class ConsumptionDiscipline(ClimateEcoDiscipline):
    ...
    def run(self):
        ...
        residential_energy = inp_dict.pop(GlossaryCore.ResidentialEnergyConsumptionDfValue)

        utility_inputs = {
            GlossaryCore.EconomicsDfValue: economics_df[[GlossaryCore.Years, GlossaryCore.OutputNetOfDamage]],
    ...
    def compute_sos_jacobian(self):
        ...
        d_period_utility_d_energy_price, d_discounted_utility_d_energy_price, d_welfare_d_energy_price = (
        ...
        self.set_partial_derivative_for_other_types(
            ("min_utility_objective",),
            (GlossaryCore.ResidentialEnergyConsumptionDfValue, GlossaryCore.TotalProductionValue),
            np.dot(d_obj_d_discounted_utility, d_discounted_utility_d_residential_energy),
        )
        self.set_partial_derivative_for_other_types(
            ("min_utility_objective",),
            (GlossaryCore.PopulationDfValue, GlossaryCore.PopulationValue),
    ...
    def get_post_processing_list(self, chart_filters=None):
        ...
        if "Energy ratios" in chart_list:
            ...
            residential_energy_conso_ref = self.get_sosdisc_inputs("residential_energy_conso_ref")
            ...
            new_chart = TwoAxesInstanciatedChart(GlossaryCore.Years, "", chart_name=chart_name)
