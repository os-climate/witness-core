...
def post_processings(execution_engine, namespace, filters):
    ...
    if 'Temperature vs Welfare' in graphs_list:
        ...
        sorted_list = sorted([[temperature[scenario], welfare[scenario]]
...
def get_df(execution_engine, namespace):
    ...
    scenario_key = execution_engine.dm.get_data_id(f'{namespace_w}.scenario_df')
    scenario_list = list(execution_engine.dm.data_dict[scenario_key][DataManager.VALUE]['scenario_name'])
