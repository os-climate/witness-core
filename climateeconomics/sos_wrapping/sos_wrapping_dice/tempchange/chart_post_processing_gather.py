...
def get_chart_filter_list(discipline):
    ...
    chart_filters.append(ChartFilter("graphs", chart_list, chart_list, "graphs"))
...
def get_instanciated_charts(discipline, chart_filters=None):
    ...
    temperature_df_dict = discipline.get_sosdisc_outputs("temperature_df_dict")

    if "Atmospheric temperature evolution" in graphs_list:

        chart_name = "Atmospheric temperature evolution over years"
        new_chart = TwoAxesInstanciatedChart(
            GlossaryCore.Years, "temperature evolution (degrees Celsius above preindustrial)", chart_name=chart_name
        )
