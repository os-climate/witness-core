...
class DamageDiscipline(SoSWrapp):
    ...
    DESC_IN = {
        ...
        "init_cost_backstop": {"type": "float", "default": 0.025},
        "gr_base_carbonprice": {"type": "float", "default": 0.02},
    ...
    DESC_OUT = {GlossaryCore.DamageDfValue: {"type": "dataframe", "visibility": "Shared", "namespace": "ns_scenario"}}
    _maturity = "Research"
    ...
    def run(self):
        ...
        damage_df = model.compute(economics_df, emissions_df, temperature_df, emissions_control_rate)
