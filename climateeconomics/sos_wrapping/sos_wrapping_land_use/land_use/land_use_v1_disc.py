...
class LandUseV1Discipline(SoSWrapp):
    ...
    DESC_IN = {
        ...
        LandUseV1.LAND_DEMAND_DF: {
            "type": "dataframe",
            "unit": "Gha",
            "visibility": SoSWrapp.SHARED_VISIBILITY,
            "namespace": "ns_land_use",
            "dataframe_descriptor": {
                ...
                "CropEnergy (Gha)": ("float", None, False),
            },
        },
        LandUseV1.TOTAL_FOOD_LAND_SURFACE: {
            "type": "dataframe",
            "unit": "Gha",
            "visibility": SoSWrapp.SHARED_VISIBILITY,
    ...
    def run(self):
        ...
        total_food_land_surface = deepcopy(inputs_dict["total_food_land_surface"])
        ...
        self.land_use_model.compute(land_demand_df, total_food_land_surface, deforested_surface_df)
        ...
        outputs_dict = {
            ...
            LandUseV1.LAND_SURFACE_DF: self.land_use_model.land_surface_df[["Agriculture (Gha)", "Forest (Gha)"]],
        ...
        for objective_column in land_demand_constraint_columns:
            for demand_column in land_demand_df_columns:
                self.set_partial_derivative_for_other_types(
                    (LandUseV1.LAND_DEMAND_CONSTRAINT, objective_column),
                    (LandUseV1.LAND_DEMAND_DF, demand_column),
                    model.get_derivative(objective_column, demand_column),
                )

            self.set_partial_derivative_for_other_types(
                (LandUseV1.LAND_DEMAND_CONSTRAINT, objective_column),
                (LandUseV1.TOTAL_FOOD_LAND_SURFACE, "total surface (Gha)"),
                model.d_land_demand_constraint_d_food_land_surface(objective_column),
            )

            self.set_partial_derivative_for_other_types(
                (LandUseV1.LAND_DEMAND_CONSTRAINT, objective_column),
                (LandUseV1.DEFORESTED_SURFACE_DF, "forest_surface_evol"),
                model.d_land_demand_constraint_d_deforestation_surface(objective_column),
            )

        d_surface_d_population = model.d_land_surface_for_food_d_food_land_surface()
        self.set_partial_derivative_for_other_types(
            (LandUseV1.LAND_SURFACE_FOR_FOOD_DF, "Agriculture total (Gha)"),
            (LandUseV1.TOTAL_FOOD_LAND_SURFACE, "total surface (Gha)"),
            d_surface_d_population,
        )
        for objective_column in land_surface_df_columns:
            self.set_partial_derivative_for_other_types(
                (LandUseV1.LAND_SURFACE_DF, objective_column),
                (LandUseV1.TOTAL_FOOD_LAND_SURFACE, "total surface (Gha)"),
                model.d_agriculture_surface_d_food_land_surface(objective_column),
            )
            ...
            for demand_column in land_demand_df_columns:
                self.set_partial_derivative_for_other_types(
                    (LandUseV1.LAND_SURFACE_DF, objective_column),
                    (LandUseV1.LAND_DEMAND_DF, demand_column),
                    model.d_constraint_d_surface(objective_column, demand_column),
                )

            self.set_partial_derivative_for_other_types(
                (LandUseV1.LAND_SURFACE_DF, objective_column),
                (LandUseV1.DEFORESTED_SURFACE_DF, "forest_surface_evol"),
                model.d_land_surface_d_deforestation_surface(objective_column),
            )
    ...
    def get_chart_filter_list(self):
        ...
        chart_list = [
            LandUseV1Discipline.AGRICULTURE_CHARTS,
            LandUseV1Discipline.FOREST_CHARTS,
            LandUseV1Discipline.GLOBAL_CHARTS,
        ]
    ...
    def get_post_processing_list(self, chart_filters=None):
        ...
        if LandUseV1Discipline.FOREST_CHARTS in chart_list:
            ...
            if demand_df is not None:
                ...
                for column in list(demand_df):
                    ...
                    if column in LandUseV1.FOREST_TECHNO:
                        ...
                        new_series = InstanciatedSeries(
                            years,
                            (demand_df[column]).values.tolist(),
                            column.replace("(Gha)", ""),
                ...
                new_chart = TwoAxesInstanciatedChart(
                    GlossaryCore.Years,
                    LandUseV1Discipline.FOREST_CHARTS,
                    chart_name=LandUseV1Discipline.FOREST_CHARTS,
                    stacked_bar=True,
                )
        ...
        if LandUseV1Discipline.AGRICULTURE_CHARTS in chart_list:
            ...
            if demand_df is not None:
                ...
                new_chart = TwoAxesInstanciatedChart(
                    GlossaryCore.Years,
                    LandUseV1Discipline.AGRICULTURE_CHARTS,
                    chart_name=LandUseV1Discipline.AGRICULTURE_CHARTS,
                    stacked_bar=True,
                )
        ...
        if LandUseV1Discipline.GLOBAL_CHARTS in chart_list:
            ...
            for year in years_list:
                ...
                fig = go.Figure(
                    go.Sunburst(
                        ...
                        values=[14.9, 36.1, 10.5, 1.5, 2.8, 5.1, 3.9, 1.2, 0.15, 0.15],
                        marker=dict(
                            colors=[
                                "#CD912A",
                                "#1456C5",
                ...
                fig.update_layout(autosize=True, margin=dict(t=80, l=0, r=0, b=0))

                # Create native plotly chart
                chart_name = f"Global land use (Gha) in {year}"
                land_use_chart = InstantiatedPlotlyNativeChart(fig=fig, chart_name=chart_name)
            ...
            agriculture_surface = InstanciatedSeries(
                years,
                (surface_df["Agriculture total (Gha)"]).values.tolist(),
                surface_df["Agriculture total (Gha)"].name.replace(" total (Gha)", ""),
                InstanciatedSeries.BAR_DISPLAY,
            )
            ...
            forest_surface = InstanciatedSeries(
                years,
                (surface_df["Forest (Gha)"]).values.tolist(),
                surface_df["Forest (Gha)"].name.replace("(Gha)", ""),
                InstanciatedSeries.BAR_DISPLAY,
            )
            ...
            new_chart = TwoAxesInstanciatedChart(
                GlossaryCore.Years,
                LandUseV1Discipline.GLOBAL_CHARTS,
                chart_name=LandUseV1Discipline.GLOBAL_CHARTS,
                stacked_bar=True,
            )
            for serie in series_to_add:
                new_chart.add_series(serie)
