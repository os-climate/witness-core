class GlossaryCore:
    ...
    CO2EmissionsGt = {'var_name': 'co2_emissions_Gt',
                      'type': 'dataframe', 'visibility': 'Shared',
    ...
    Economics_df = {'var_name': 'economics_df',
                    'type': 'dataframe',
                    'visibility': 'Shared',
                    'namespace': 'ns_witness',
                    'unit': '-',
    ...
    PopulationDF = {'var_name': 'population_df',
                    'type': 'dataframe',
    ...
    ShareEnergyInvestment = {'var_name': 'share_energy_investment',
                       'type': 'dataframe', 'unit': '%',
                         'dataframe_descriptor': {Years: ('float', None, False),
                                                  'energy': ('float', [0., 100.], True), },
                         'dataframe_edition_locked': False,
                       'visibility': 'Shared',
                         'namespace': 'ns_witness'}

    ShareNonEnergyInvestment = {'var_name': 'share_non_energy_investment',
                             'type': 'dataframe', 'unit': '%',
                             'dataframe_descriptor': {Years: ('float', None, False),
                                                      'non_energy': ('float', [0., 100.], True), },
                             'dataframe_edition_locked': False,
                             'visibility': 'Shared',
                             'namespace': 'ns_witness'}
