...
Modifications on 2023/11/02-2023/11/06 Copyright 2023 Capgemini
...
class ProcessBuilder(BaseProcessBuilder):
    ...
    def get_builders(self):
        ...
        mods_dict = {'Macroeconomics': 'climateeconomics.sos_wrapping.sos_wrapping_witness.macroeconomics_thesis_narrative.macroeconomics_discipline.MacroeconomicsDiscipline',
