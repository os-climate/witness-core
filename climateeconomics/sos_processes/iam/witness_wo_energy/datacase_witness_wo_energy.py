...
# "reduced.pdf")
    ...
    def setup_objectives(self):
        ...
        list_ns = []
        list_var.extend(
            ['welfare_objective',  'temperature_objective', 'CO2_objective', 'ppm_objective', 'non_use_capital_objective', 'delta_capital_objective'])
        list_parent.extend(['utility_objective',
                            'CO2_obj', 'CO2_obj', 'CO2_obj', 'non_use_capital_objective', 'delta_capital_objective'])
        list_ns.extend(['ns_functions',
                        'ns_functions', 'ns_functions', 'ns_functions', 'ns_witness','ns_functions'])
        list_ftype.extend(
            [OBJECTIVE,  OBJECTIVE, OBJECTIVE, OBJECTIVE, OBJECTIVE, OBJECTIVE])
        list_weight.extend([1.0,  0.0, 1.0, 0.0, 1.0, 0.0])
