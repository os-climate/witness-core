...
Modifications on 2023/07/13-2023/11/02 Copyright 2023 Capgemini
...
class ProcessBuilder(WITNESSSubProcessBuilder):
    ...
    def get_builders(self):
        ...
        coupling_builder = self.ee.factory.get_builder_from_process(
            ...
            techno_dict=techno_dict, invest_discipline=INVEST_DISCIPLINE_OPTIONS[2], process_level='thesis')
