...
class ProcessBuilder(EnergyProcessBuilder):
    ...
    def get_builders(self):
        ...
        ns_forest = "Forest"
        ns_dict = {
            "ns_agriculture": f"{ns_study}.{ns_agriculture_mix}",
        ...
        agrimix_builder = self.ee.factory.get_builder_from_module(ns_agriculture_mix, agricultureDiscPath)
        ...
        for model_name in self.model_list:
            ...
            if model_name == "Crop":
                ...
                builder = self.ee.factory.get_builder_from_module(f"{ns_agriculture_mix}.{model_name}", technoDiscPath)
            elif model_name == "Forest":
                technoDiscPath = (
                    "climateeconomics.sos_wrapping.sos_wrapping_agriculture.forest.forest_disc.ForestDiscipline"
                )
