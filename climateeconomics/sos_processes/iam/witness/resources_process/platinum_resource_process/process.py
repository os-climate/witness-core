...
class ProcessBuilder(BaseProcessBuilder):
    ...
    def get_builders(self):
        ...
        ns_dict = {
            "ns_platinum_resource": ns_scatter,
            "ns_public": ns_scatter,
            "ns_resource": ns_scatter,
        }

        mods_dict = {
            "PlatinumResourceModel": "climateeconomics.core.core_resources.models.platinum_resource.platinum_resource_disc.PlatinumResourceDiscipline"
        }
