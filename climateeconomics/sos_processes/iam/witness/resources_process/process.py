...
class ProcessBuilder(BaseProcessBuilder):
    ...
    def get_builders(self):
        ...
        ns_dict = {
            "ns_coal_resource": f"{ns_scatter}.{self.COAL_NAME}",
        ...
        mods_dict = {
            f"Resources.{self.COAL_NAME}": "climateeconomics.core.core_resources.models.coal_resource.coal_resource_disc.CoalResourceDiscipline",
        ...
        builder_list = self.create_builder_list(
            mods_dict, ns_dict=ns_dict, associate_namespace=self.associate_namespace
        )
