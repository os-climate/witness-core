...
class Study(ClimateEconomicsStudyManager):
    ...
    USECASE2 = StDB.USECASE2
    USECASE4_TP1 = StDB.USECASE4 + ', ' + TIPPING_POINT + SEP + str(TIPPING_POINT_LIST[0]).replace('.', '_') + UNIT
    USECASE4_TP2 = StDB.USECASE4 + ', ' + TIPPING_POINT + SEP + str(TIPPING_POINT_LIST[1]).replace('.', '_') + UNIT
    USECASE4_TP3 = StDB.USECASE4 + ', ' + TIPPING_POINT + SEP + str(TIPPING_POINT_LIST[2]).replace('.', '_') + UNIT
    USECASE7_TP1 = StDB.USECASE7 + ', ' + TIPPING_POINT + SEP + str(TIPPING_POINT_LIST[0]).replace('.', '_') + UNIT
    USECASE7_TP2 = StDB.USECASE7 + ', ' + TIPPING_POINT + SEP + str(TIPPING_POINT_LIST[1]).replace('.', '_') + UNIT
    USECASE7_TP3 = StDB.USECASE7 + ', ' + TIPPING_POINT + SEP + str(TIPPING_POINT_LIST[2]).replace('.', '_') + UNIT
    ...
    def setup_usecase(self, study_folder_path=None):
        ...
        scenario_dict = {
            ...
            self.USECASE4_TP1: {
                ...
                "tp_a3": self.TIPPING_POINT_LIST[0]
            },
            self.USECASE4_TP2: {
                "invest_mix": StDB.UC4EnergyInvestMix.value,
                "tp_a3": self.TIPPING_POINT_LIST[1]
            },
            self.USECASE4_TP3: {
                "invest_mix": StDB.UC4EnergyInvestMix.value,
                "tp_a3": self.TIPPING_POINT_LIST[2]
            },
            self.USECASE7_TP1: {
        ...
        values_dict.update({f"{self.study_name}.{scatter_scenario}.{self.USECASE2}.MDO.WITNESS_Eval.WITNESS.co2_damage_price_percentage": 0.0})
