...
class Study(StudySubOptim):
    ...
    def setup_usecase(self, study_folder_path=None):
        ...
        data_witness[0].update({
            f"{self.study_name}.{self.witness_uc.coupling_name}.{self.witness_uc.extra_name}.ccs_price_percentage": 100.0,
            f"{self.study_name}.{self.witness_uc.coupling_name}.{self.witness_uc.extra_name}.co2_damage_price_percentage": 100.0,
        })
