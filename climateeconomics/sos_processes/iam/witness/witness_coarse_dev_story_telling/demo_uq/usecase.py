...
class Study(StudyManager):
    ...
    def setup_usecase(self) -> dict[str, Any]:
        ...
        input_selection = {
            ...
            "full_name": [
                f"{self.study_name}.DOE.RenewableTechnoInfo.Opex_percentage",
                f"{self.study_name}.DOE.RenewableTechnoInfo.Initial_capex",
                f"{self.study_name}.DOE.RenewableTechnoInfo.Energy_costs",
                f"{self.study_name}.DOE.FossilTechnoInfo.Opex_percentage",
                f"{self.study_name}.DOE.FossilTechnoInfo.Initial_capex",
                f"{self.study_name}.DOE.FossilTechnoInfo.Energy_costs",
                f"{self.study_name}.DOE.FossilTechnoInfo.CO2_from_production",
                f"{self.study_name}.DOE.Damage.tp_a3",
                f"{self.study_name}.DOE.Temperature_change.init_temp_atmo",
            ],
        }
        ...
        output_selection = {
            ...
            "full_name": [
                f"{self.study_name}.DOE.Indicators.mean_energy_price_2100",
                f"{self.study_name}.DOE.Indicators.fossil_energy_price_2100",
                f"{self.study_name}.DOE.Indicators.renewable_energy_price_2100",
                f"{self.study_name}.DOE.Indicators.total_energy_production_2100",
                f"{self.study_name}.DOE.Indicators.fossil_energy_production_2100",
                f"{self.study_name}.DOE.Indicators.renewable_energy_production_2100",
                f"{self.study_name}.DOE.Indicators.world_net_product_2100",
                f"{self.study_name}.DOE.Indicators.temperature_rise_2100",
