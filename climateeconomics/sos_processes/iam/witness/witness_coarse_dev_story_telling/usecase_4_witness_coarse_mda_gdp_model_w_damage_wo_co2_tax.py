...
class Study(ClimateEconomicsStudyManager):
    """
    Usecase 4, mda run only, no optim, based on usecase_witness_coarse_new. Working assumptions:
    ...
    def setup_usecase(self, study_folder_path=None):
        ...
        invest_percentage_gdp_df = pd.read_csv(join(dirname(__file__), "uc4_percentage_of_gdp_energy_invest.csv"))
        invest_percentage_per_techno_df = pd.read_csv(join(dirname(__file__), "uc4_techno_invest_percentage.csv"))
