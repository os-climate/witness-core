...
class Study(ClimateEconomicsStudyManager):
    """
    Usecase 3, mda run only, no optim, based on usecase_witness_coarse_new. Working assumptions:
    - Macro-model: compute GDP
    - Damage: N/A
    - Tax: activated, ie ccs price percentage at 100
    - invest: mix fossil renewable (IEA inspired - steps- )
    """
