...
from energy_models.core.energy_study_manager import DEFAULT_COARSE_TECHNO_DICT_ccs_2
...
class Study(StudyManager):
    ...
    def __init__(self, year_start=2020, year_end=2100, time_step=1, bspline=False, run_usecase=False, execution_engine=None,
                 invest_discipline=INVEST_DISCIPLINE_OPTIONS[1], techno_dict=DEFAULT_COARSE_TECHNO_DICT_ccs_2):
