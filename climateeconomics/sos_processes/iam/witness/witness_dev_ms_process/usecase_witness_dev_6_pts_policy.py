...
from climateeconomics.sos_processes.iam.witness.witness_dev_optim_process.usecase_witness_optim_invest_distrib import Study as witness_dev_optim_usecase
...
class Study(ClimateEconomicsStudyManager):
    ...
    def setup_usecase(self):
        witness_ms_usecase = witness_dev_optim_usecase(
        ...
        for scenario in scenario_list:
            scenarioUseCase = witness_dev_optim_usecase(
