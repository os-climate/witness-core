...
class Study(StudyManager):
    ...
    def setup_usecase(self, study_folder_path=None):
        ...
        inputs_dict = {
            ...
            f'{ns_study}.{model_name}.Agriculture.{GlossaryCore.Crop}.{GlossaryCore.InvestmentDetailsDfValue}': investments,
            f'{ns_study}.{GlossaryCore.EconomicsDfValue}': economics_df,
            f'{ns_study}.{GlossaryCore.EnergyMarketRatioAvailabilitiesValue}': energy_market_ratios,
