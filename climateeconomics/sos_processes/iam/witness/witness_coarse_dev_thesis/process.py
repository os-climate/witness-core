...
class ProcessBuilder(WITNESSSubProcessBuilder):
    ...
    def get_builders(self):
        ...
        '''
        mods_dict = {
            'InvestmentDistribution': 'climateeconomics.sos_wrapping.sos_wrapping_witness.non_use_capital_objective.non_use_capital_obj_discipline.NonUseCapitalObjectiveDiscipline'
            }
