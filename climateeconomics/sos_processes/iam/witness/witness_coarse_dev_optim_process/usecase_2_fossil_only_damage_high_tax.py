...
class Study(StudyOptimInvestDistrib):
    ...
    def setup_usecase(self, study_folder_path=None):
        ...
        dspace_invests = {
            ...
            f"{GlossaryCore.clean_energy}.{GlossaryCore.CleanEnergySimpleTechno}.{GlossaryCore.clean_energy}_{GlossaryCore.CleanEnergySimpleTechno}_array_mix": [min_invest, min_invest, max_invest, False],
        ...
        dspace_invests = make_dspace_invests(dspace_invests, self.year_start, overwrite_invest_index=[1])
        min_UR = 50.
        dspace_UR = {
            'fossil_FossilSimpleTechno_utilization_ratio_array': [min_UR, min_UR, 100., True],
            f"{GlossaryCore.clean_energy}_{GlossaryCore.CleanEnergySimpleTechno}_utilization_ratio_array": [min_UR, min_UR, 100., False],
        ...
        data_witness.update({
            ...
            f"{self.study_name}.{self.optim_name}.{self.witness_uc.coupling_name}.{self.witness_uc.extra_name}.share_non_energy_invest_ctrl": np.array([21.5] * (GlossaryCore.NB_POLES_COARSE - 1)),
        })
