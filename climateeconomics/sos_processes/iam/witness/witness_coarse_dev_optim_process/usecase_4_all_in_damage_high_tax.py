...
class Study(StudyOptimInvestDistrib):
    ...
    def setup_usecase(self, study_folder_path=None):
        ...
        dspace_UR = {
            ...
            "carbon_capture.flue_gas_capture.FlueGasTechno_utilization_ratio_array": [min_UR, min_UR, 100.0, True],
            "carbon_storage.CarbonStorageTechno_utilization_ratio_array": [min_UR, min_UR, 100.0, True],
        }
