...
class Study(StudyOptimInvestDistrib):
    ...
    def setup_usecase(self, study_folder_path=None):
        ...
        dspace_invests = {
            ...
            'carbon_capture.direct_air_capture.{GlossaryEnergy.DirectAirCaptureTechno}.carbon_capture_direct_air_capture_DirectAirCaptureTechno_array_mix': [min_invest, min_invest, max_invest, True],
