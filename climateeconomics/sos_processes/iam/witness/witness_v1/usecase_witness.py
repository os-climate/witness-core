...
class Study(ClimateEconomicsStudyManager):
    ...
    def setup_usecase(self):
        ...
        dc_forest = datacase_forest(
            self.year_start, self.year_end, self.time_step, name='.Land.Forest', execution_engine=self.execution_engine)
        ...
        # setup objectives
        self.func_df = concat(
            [dc_witness.setup_objectives(), dc_witness.setup_constraints(),
                self.dc_energy.setup_constraints(), self.dc_energy.setup_objectives(),
        ...
        self.merge_design_spaces(
            [dspace_energy, dspace_agriculture, dspace_land_use, dspace_forest])
        """
...
#         self.dspace = sum_df
        ...
        numerical_values_dict = {
            ...
            f'{self.study_name}.max_mda_iter_gs': 5,
