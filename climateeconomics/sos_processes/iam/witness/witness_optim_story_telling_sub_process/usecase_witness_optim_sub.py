...
class Study(ClimateEconomicsStudyManager):
    ...
    def __init__(
        ...
        if sub_usecase == "uc2":
            self.witness_uc = witness_usecase2_story_telling(self.year_start, self.year_end, self.time_step)
    ...
    def setup_usecase(self, study_folder_path=None):
        ...
        # design space
        dspace_dict = {
            "variable": ["percentage_gdp_invest_in_energy_array"],
            "value": [[1.0] * len_var],
            "lower_bnd": [[2e-1] * len_var],
            "upper_bnd": [[5.0] * len_var],
        ...
        values_dict[
            f"{self.study_name}.{self.coupling_name}.{self.extra_name}.percentage_gdp_invest_in_energy_array"
        ] = np.ones(len_var)
