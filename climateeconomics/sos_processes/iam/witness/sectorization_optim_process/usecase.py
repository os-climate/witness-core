...
class Study(StudyManager):
    ...
    def __init__(
        ...
        self.witness_sect_uc = witness_sect_usecase(
            self.year_start, self.year_end, self.time_step, execution_engine=execution_engine, main_study=False
        )
    ...
    def setup_usecase(self, study_folder_path=None):
        ...
        ns_industry_macro = (
            f"{self.study_name}.{self.optim_name}.{self.coupling_name}.{self.macro_name}.{GlossaryCore.SectorIndustry}"
        )
        ns_agriculture_macro = f"{self.study_name}.{self.optim_name}.{self.coupling_name}.{self.macro_name}.{GlossaryCore.SectorAgriculture}"
        ns_services_macro = (
            f"{self.study_name}.{self.optim_name}.{self.coupling_name}.{self.macro_name}.{GlossaryCore.SectorServices}"
        )
        sect_input = {}
