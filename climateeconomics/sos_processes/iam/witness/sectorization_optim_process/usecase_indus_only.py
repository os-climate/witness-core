...
class Study(StudyManager):
    ...
    def setup_usecase(self):
        ...
        dspace_dict = {'variable': ['output_alpha_indus_in', 'prod_gr_start_indus_in','decl_rate_tfp_indus_in','prod_start_indus_in', 
        ...
        agri = 'Agriculture.'
        industry = 'Industry.'
        design_var_descriptor = {'output_alpha_indus_in': {'out_name': industry+'output_alpha','out_type': 'float', 'index': arange(1),
