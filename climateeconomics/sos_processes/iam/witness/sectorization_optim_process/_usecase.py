...
class Study(StudyManager):
    ...
    def __init__(
        self,
        year_start=2000,
        year_end=GlossaryCore.YearStartDefault,
        time_step=1,
        name="",
        ...
        self.ns_agriculture = (
            f"{self.study_name}.{self.optim_name}.{self.coupling_name}.{GlossaryCore.SectorAgriculture}"
        )
        self.ns_services = f"{self.study_name}.{self.optim_name}.{self.coupling_name}.{GlossaryCore.SectorServices}"
        self.year_start = year_start
        self.year_end = year_end
        self.time_step = time_step
        self.witness_sect_uc = witness_sect_usecase(
    ...
    def setup_usecase(self, study_folder_path=None):
        ...
        dspace_dict = {
            "variable": [
                "output_alpha_services_in",
                "prod_gr_start_services_in",
                "decl_rate_tfp_services_in",
                "prod_start_services_in",
                "energy_eff_k_services_in",
                "energy_eff_cst_services_in",
                "energy_eff_xzero_services_in",
                "energy_eff_max_services_in",
                "output_alpha_agri_in",
                "prod_gr_start_agri_in",
                "decl_rate_tfp_agri_in",
                "prod_start_agri_in",
                "energy_eff_k_agri_in",
                "energy_eff_cst_agri_in",
                "energy_eff_xzero_agri_in",
                "energy_eff_max_agri_in",
                "output_alpha_indus_in",
                "prod_gr_start_indus_in",
                "decl_rate_tfp_indus_in",
                "prod_start_indus_in",
                "energy_eff_k_indus_in",
                "energy_eff_cst_indus_in",
                "energy_eff_xzero_indus_in",
        ...
        design_var_descriptor = {
            "output_alpha_services_in": {
                "out_name": services + "output_alpha",
                "out_type": "float",
                "index": arange(1),
                "namespace_in": "ns_optim",
                "namespace_out": GlossaryCore.NS_MACRO,
            },
            "prod_gr_start_services_in": {
                "out_name": services + "productivity_gr_start",
                "out_type": "float",
                "index": arange(1),
                "namespace_in": "ns_optim",
                "namespace_out": GlossaryCore.NS_MACRO,
            ...
            "decl_rate_tfp_services_in": {
                "out_name": services + "decline_rate_tfp",
                "out_type": "float",
                "index": arange(1),
                "namespace_in": "ns_optim",
                "namespace_out": GlossaryCore.NS_MACRO,
            ...
            "prod_start_services_in": {
                "out_name": services + "productivity_start",
                "out_type": "float",
                "index": arange(1),
                "namespace_in": "ns_optim",
                "namespace_out": GlossaryCore.NS_MACRO,
            ...
            "energy_eff_k_services_in": {
                "out_name": services + "energy_eff_k",
                "out_type": "float",
                "index": arange(1),
                "namespace_in": "ns_optim",
                "namespace_out": GlossaryCore.NS_MACRO,
            ...
            "energy_eff_cst_services_in": {
                "out_name": services + "energy_eff_cst",
                "out_type": "float",
                "index": arange(1),
                "namespace_in": "ns_optim",
                "namespace_out": GlossaryCore.NS_MACRO,
            ...
            "energy_eff_xzero_services_in": {
                "out_name": services + "energy_eff_xzero",
                "out_type": "float",
                "index": arange(1),
                "namespace_in": "ns_optim",
                "namespace_out": GlossaryCore.NS_MACRO,
            ...
            "energy_eff_max_services_in": {
                "out_name": services + "energy_eff_max",
                "out_type": "float",
                "index": arange(1),
                "namespace_in": "ns_optim",
                "namespace_out": GlossaryCore.NS_MACRO,
            ...
            "prod_gr_start_agri_in": {
                "out_name": agri + "productivity_gr_start",
                "out_type": "float",
                "index": arange(1),
                "namespace_in": "ns_optim",
                "namespace_out": GlossaryCore.NS_MACRO,
            ...
            "decl_rate_tfp_agri_in": {
                "out_name": agri + "decline_rate_tfp",
                "out_type": "float",
                "index": arange(1),
                "namespace_in": "ns_optim",
                "namespace_out": GlossaryCore.NS_MACRO,
            ...
            "prod_start_agri_in": {
                "out_name": agri + "productivity_start",
                "out_type": "float",
                "index": arange(1),
                "namespace_in": "ns_optim",
                "namespace_out": GlossaryCore.NS_MACRO,
            ...
            "energy_eff_xzero_agri_in": {
                "out_name": agri + "energy_eff_xzero",
                "out_type": "float",
                "index": arange(1),
                "namespace_in": "ns_optim",
                "namespace_out": GlossaryCore.NS_MACRO,
            ...
            "output_alpha_indus_in": {
                "out_name": industry + "output_alpha",
                "out_type": "float",
                "index": arange(1),
                "namespace_in": "ns_optim",
                "namespace_out": GlossaryCore.NS_MACRO,
            ...
            "prod_gr_start_indus_in": {
                "out_name": industry + "productivity_gr_start",
                "out_type": "float",
                "index": arange(1),
                "namespace_in": "ns_optim",
                "namespace_out": GlossaryCore.NS_MACRO,
            ...
            "decl_rate_tfp_indus_in": {
                "out_name": industry + "decline_rate_tfp",
                "out_type": "float",
                "index": arange(1),
                "namespace_in": "ns_optim",
                "namespace_out": GlossaryCore.NS_MACRO,
            ...
            "prod_start_indus_in": {
                "out_name": industry + "productivity_start",
                "out_type": "float",
                "index": arange(1),
                "namespace_in": "ns_optim",
                "namespace_out": GlossaryCore.NS_MACRO,
            ...
            "energy_eff_k_indus_in": {
                "out_name": industry + "energy_eff_k",
                "out_type": "float",
                "index": arange(1),
                "namespace_in": "ns_optim",
                "namespace_out": GlossaryCore.NS_MACRO,
            ...
            "energy_eff_cst_indus_in": {
                "out_name": industry + "energy_eff_cst",
                "out_type": "float",
                "index": arange(1),
                "namespace_in": "ns_optim",
                "namespace_out": GlossaryCore.NS_MACRO,
            ...
            "energy_eff_xzero_indus_in": {
                "out_name": industry + "energy_eff_xzero",
                "out_type": "float",
                "index": arange(1),
                "namespace_in": "ns_optim",
                "namespace_out": GlossaryCore.NS_MACRO,
            ...
            "energy_eff_max_indus_in": {
                "out_name": industry + "energy_eff_max",
                "out_type": "float",
                "index": arange(1),
                "namespace_in": "ns_optim",
                "namespace_out": GlossaryCore.NS_MACRO,
        ...
        disc_dict[f"{ns_optim}.{'fd_step'}"] = 1.0e-15
        ...
        func_df = pd.DataFrame(columns=["variable", "ftype", "weight", AGGR_TYPE, "namespace"])
        func_df["variable"] = [
            "error_pib_total",
            "Industry.gdp_error",
            "Agriculture.gdp_error",
            "Services.gdp_error",
            "Industry.energy_eff_error",
            "Agriculture.energy_eff_error",
        ...
        data_dir = join(dirname(dirname(dirname(dirname(dirname(__file__))))), "tests", "data/sectorization_fitting")
        ...
        agri_invest = pd.DataFrame(
            {
                GlossaryCore.Years: hist_invest[GlossaryCore.Years],
                GlossaryCore.SectorAgriculture: hist_invest[GlossaryCore.SectorAgriculture],
            }
        )
        services_invest = pd.DataFrame(
            {
                GlossaryCore.Years: hist_invest[GlossaryCore.Years],
                GlossaryCore.SectorServices: hist_invest[GlossaryCore.SectorServices],
            }
        )
        indus_invest = pd.DataFrame(
            {
                GlossaryCore.Years: hist_invest[GlossaryCore.Years],
                GlossaryCore.SectorIndustry: hist_invest[GlossaryCore.SectorIndustry],
            }
        )
        long_term_energy_eff = pd.read_csv(join(data_dir, "long_term_energy_eff_sectors.csv"))
        lt_enef_agri = pd.DataFrame(
            {
        ...
        sect_input = {}
        sect_input[
            f"{ns_coupling}.{self.macro_name}.{GlossaryCore.SectorIndustry}.{GlossaryCore.InvestmentDfValue}"
        ] = invest_indus
        sect_input[
            f"{ns_coupling}.{self.macro_name}.{GlossaryCore.SectorAgriculture}.{GlossaryCore.InvestmentDfValue}"
        ] = invest_agriculture
        sect_input[
            f"{ns_coupling}.{self.macro_name}.{GlossaryCore.SectorServices}.{GlossaryCore.InvestmentDfValue}"
        ] = invest_services
        sect_input[
            f"{ns_coupling}.{self.macro_name}.{GlossaryCore.SectorIndustry}.{GlossaryCore.EnergyProductionValue}"
        ] = indus_energy
        sect_input[
            f"{ns_coupling}.{self.macro_name}.{GlossaryCore.SectorAgriculture}.{GlossaryCore.EnergyProductionValue}"
        ] = agri_energy
        sect_input[
            f"{ns_coupling}.{self.macro_name}.{GlossaryCore.SectorServices}.{GlossaryCore.EnergyProductionValue}"
        ] = services_energy
