...
class ProcessBuilder(BaseProcessBuilder):
    ...
    def get_builders(self):
        ...
        self.ee.post_processing_manager.add_post_processing_module_to_namespace(
            'ns_scatter_scenario', 'climateeconomics.sos_wrapping.sos_wrapping_witness.post_proc_witness_ms.post_processing_witness_coarse_mda')
        self.ee.post_processing_manager.add_post_processing_module_to_namespace(
            'ns_scatter_scenario', 'climateeconomics.sos_wrapping.sos_wrapping_witness.post_proc_witness_ms.post_processing_witness_full')
