...
class Study(ClimateEconomicsStudyManager):
    ...
    def setup_usecase(self, study_folder_path=None):
        ...
        values_dict.update(
            {
                f"{self.study_name}.{scatter_scenario}.{scenario_name}.WITNESS_MDO.max_iter": 100
        ...
        values_dict.update(
            {
                f"{self.study_name}.{scatter_scenario}.{uc4_tp1}.WITNESS_MDO.WITNESS_Eval.WITNESS.{tipping_point_variable}": 4.0,
                f"{self.study_name}.{scatter_scenario}.{uc4_tp2}.WITNESS_MDO.WITNESS_Eval.WITNESS.{tipping_point_variable}": 3.0,
                f"{self.study_name}.{scatter_scenario}.{uc7_tp1}.WITNESS_MDO.WITNESS_Eval.WITNESS.{tipping_point_variable}": 4.0,
                f"{self.study_name}.{scatter_scenario}.{uc7_tp2}.WITNESS_MDO.WITNESS_Eval.WITNESS.{tipping_point_variable}": 3.0,
            }
        )
