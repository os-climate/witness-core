...
class Study(ClimateEconomicsStudyManager):
    ...
    def setup_usecase(self, study_folder_path=None):
        ...
        values_dict.update({
            f'{self.study_name}.{self.scatter_scenario}.{self.USECASE4_TP1}.{tipping_point_variable}': float(self.TIPPING_POINT_LIST[1]),
            f'{self.study_name}.{self.scatter_scenario}.{self.USECASE4_TP2}.{tipping_point_variable}': float(self.TIPPING_POINT_LIST[2]),
            f'{self.study_name}.{self.scatter_scenario}.{self.USECASE7_TP1}.{tipping_point_variable}': float(self.TIPPING_POINT_LIST[1]),
            f'{self.study_name}.{self.scatter_scenario}.{self.USECASE7_TP2}.{tipping_point_variable}': float(self.TIPPING_POINT_LIST[2]),
            })
