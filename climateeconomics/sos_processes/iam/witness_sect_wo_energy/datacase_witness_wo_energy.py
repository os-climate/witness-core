...
class DataStudy:
    ...
    def setup_usecase(self, study_folder_path=None):
        ...
        energy_investment_wo_tax = DataFrame(
            {GlossaryCore.Years: years, GlossaryCore.EnergyInvestmentsWoTaxValue: asarray([1.65] * nb_per)}, index=years
        )
        ...
        witness_input[f"{self.study_name}.{'energy_investment_before_year_start'}"] = (
            df_energy_investment_before_year_start
        )
    ...
    def setup_objectives(self):
        data = {
            ...
            "parent": ["utility_objective", "utility_objective", "GWP_long_term_obj", "non_use_capital_objective"],
