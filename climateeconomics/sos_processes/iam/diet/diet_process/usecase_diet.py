...
class Study(ClimateEconomicsStudyManager):
    ...
    def setup_usecase(self, study_folder_path=None):
        ...
        df_eco = DataFrame(
            {GlossaryCore.Years: years, GlossaryCore.OutputNetOfDamage: gdp},
        ...
        dc_agriculture_mix = datacase_agriculture_mix(self.year_start, self.year_end, self.time_step)
    ...
    def setup_objectives(self):
        ...
        list_aggr_type = []
        list_ns = []
        list_var.extend(["co2_eq_100", "co2_eq_20"])
        list_parent.extend(["CO2_obj", "CO2_obj"])
    ...
    def setup_constraint_land_use(self):
        ...
        list_aggr_type = []
        list_ns = []
        list_var.extend(["land_demand_constraint", "calories_per_day_constraint"])
