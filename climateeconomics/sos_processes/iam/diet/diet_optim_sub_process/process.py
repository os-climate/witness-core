...
class ProcessBuilder(WITNESSSubProcessBuilder):
    ...
    _ontology_data = {
        'label': 'Diet Optimization Sub-Process',
        'description': '',
        'category': '',
        'version': '',
    }
    ...
    def get_builders(self):
        ...
        chain_builders = self.ee.factory.get_builder_from_process(
            'climateeconomics.sos_processes.iam.diet', 'diet_process')
        ...
        fmanager_path = 'sostrades_optimization_plugin.models.func_manager.func_manager_disc.FunctionManagerDisc'
