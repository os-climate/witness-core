...
class Study(StudyManager):
    ...
    def setup_usecase(self, study_folder_path=None):
        ...
        dice_input[f"{self.study_name}.{'Carbon_emissions'}.{'decline_rate_land_emissions'}"] = 0.115
        ...
        dice_input[f"{self.study_name}.{'Damage'}.{'init_cost_backstop'}"] = 0.025
        dice_input[f"{self.study_name}.{'Damage'}.{'gr_base_carbonprice'}"] = 0.02
        ...
        dice_input[f"{self.study_name}.{'Macroeconomics'}.{'output_elasticity'}"] = 0.300
        ...
        dice_input[f"{self.study_name}.{'Macroeconomics'}.{'depreciation_capital'}"] = 0.100
        dice_input[f"{self.study_name}.{'init_rate_time_pref'}"] = 0.015
        ...
        dice_input[f"{self.study_name}.{'Temperature_change'}.{'init_temp_ocean'}"] = 0.00687
        ...
        emissions_control_rate = append(dice_emissions, zeros(nb_per - len(dice_emissions)))
        emissions_control_rate = DataFrame({"year": years, "value": emissions_control_rate})
