...
class AgricultureMixModelTestCase(unittest.TestCase):
    ...
    def test_agriculture_mix_discipline(self):
        ...
        inputs_dict = {f'{test_name}.{GlossaryCore.YearStart}': self.year_start,
                       ...
                       f'{test_name}.{disc_name}.Crop.{GlossaryCore.TechnoEnergyDemandsValue}': self.techno_consumption_woratio_crop,
                       ...
                       f'{test_name}.{disc_name}.Forest.{GlossaryCore.TechnoEnergyDemandsValue}': self.techno_consumption_woratio_forest,
