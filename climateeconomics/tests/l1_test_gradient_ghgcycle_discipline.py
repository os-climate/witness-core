...
class GHGCycleJacobianDiscTest(AbstractJacobianUnittest):
    ...
    def test_execute(self):
        ...
        emission_df_all['Total CO2 emissions'] = emission_df_all['total_emissions']
        ...
        values_dict = {f'{self.name}.GHG_emissions_df': emission_df_y}
    ...
    def test_execute_2(self):
        ...
        self.check_jacobian(location=dirname(__file__), filename=f'jacobian_ghg_cycle_discipline2.pkl',
                            discipline=disc_techno, step=1e-15, derr_approx='complex_step',
                            inputs=[f'{self.name}.GHG_emissions_df'],
                            outputs=[f'{self.name}.carboncycle_df',
                                     f'{self.name}.ppm_objective',
