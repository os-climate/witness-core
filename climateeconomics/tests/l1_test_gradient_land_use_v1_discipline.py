...
class LandUseV1JacobianDiscTest(AbstractJacobianUnittest):
    ...
    def analytic_grad_entry(self):
        return [self.test_land_use_v1_discipline_analytic_grad]
    ...
    def test_land_use_v1_discipline_analytic_grad(self):
        ...
        land_demand_df = read_csv(join(data_dir, "land_demand.csv"))
        ...
        land_demand_df = land_demand_df.loc[land_demand_df[GlossaryCore.Years] >= year_start]
        land_demand_df = land_demand_df.loc[land_demand_df[GlossaryCore.Years] <= year_end]
        ...
        self.deforested_surface_df = pd.DataFrame(index=years, columns=[GlossaryCore.Years, "forest_surface_evol"])
        ...
        self.check_jacobian(
            ...
            filename=f"jacobian_land_use_v1_discipline.pkl",
            ...
            outputs=[
                f"{self.name}.land_demand_constraint",
