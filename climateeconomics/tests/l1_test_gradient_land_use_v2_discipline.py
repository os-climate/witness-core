...
class LandUseV2JacobianDiscTest(AbstractJacobianUnittest):
    ...
    def analytic_grad_entry(self):
        return [self.test_land_use_v2_discipline_analytic_grad]
    ...
    def test_land_use_v2_discipline_analytic_grad(self):
        ...
        land_demand_df = read_csv(join(data_dir, "land_demandV2.csv"))
        ...
        self.check_jacobian(
            ...
            filename=f"jacobian_land_use_v2_discipline.pkl",
