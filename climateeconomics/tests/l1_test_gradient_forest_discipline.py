...
class ForestJacobianDiscTest(AbstractJacobianUnittest):
    ...
    def test_forest_analytic_grad(self):
        ...
        mod_path = 'climateeconomics.sos_wrapping.sos_wrapping_forest.forest.forest_disc.ForestDiscipline'
        ...
        inputs_dict = {f'{self.name}.year_start': self.year_start,
                       ...
                       f'{self.name}.{model_name}.{Forest.DEFORESTATION_SURFACE}': self.deforestation_surface_df,
        ...
        self.check_jacobian(location=dirname(__file__), filename=f'jacobian_forest_discipline.pkl',
                            discipline=disc_techno, step=1e-15, derr_approx='complex_step',
                            inputs=[
                                f'{self.name}.{Forest.DEFORESTATION_SURFACE}'],
                            outputs=[f'{self.name}.{Forest.DEFORESTED_SURFACE_DF}',
