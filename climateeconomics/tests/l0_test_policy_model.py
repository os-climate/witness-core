...
class PolicyDiscTest(unittest.TestCase):
    ...
    def test_execute(self):
        ...
        values_dict = {
            ...
            f"{self.name}.co2_damage_price_percentage": 50.0,
        }
        ...
        max_CCS_CO2 = np.maximum(CCS_price["ccs_price_per_tCO2"], CO2_damage[GlossaryCore.CO2DamagePrice])
        ...
        filters = ppf.get_post_processing_filters_by_discipline(disc[0])
        graph_list = ppf.get_post_processing_by_discipline(disc[0], filters, as_json=False)
