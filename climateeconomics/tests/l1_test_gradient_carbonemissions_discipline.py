...
class CarbonEmissionsJacobianDiscTest(AbstractJacobianUnittest):
    ...
    def analytic_grad_entry(self):
        return [self.test_carbon_emissions_analytic_grad, self.test_co2_objective_limit_grad]
    ...
    def test_carbon_emissions_analytic_grad(self):
        ...
        values_dict = {
            ...
            f"{self.name}.{GlossaryCore.insertGHGAgriLandEmissions.format(GlossaryCore.CO2)}": self.CO2_emitted_forest,
        ...
        self.check_jacobian(
            ...
            filename=f"jacobian_carbon_emission_discipline.pkl",
    ...
    def test_co2_objective_limit_grad(self):
        ...
        self.check_jacobian(
            location=dirname(__file__),
            filename=f"jacobian_co2_objective_limit.pkl",
            discipline=disc_techno,
            step=1e-15,
            derr_approx="complex_step",
            local_data=disc_techno.local_data,
