...
class NonUseCapitalObjJacobianDiscTest(AbstractJacobianUnittest):
    ...
    def setUp(self):
        ...
        self.values_dict = {f'{self.name}.{GlossaryCore.YearStart}': year_start,
                            ...
                            f'{self.name}.{GlossaryCore.energy_list}': ['fuel_production.liquid_fuel', 'methane'],
                            ...
                            f'{self.name}.EnergyMix.fuel_production.liquid_fuel.{GlossaryCore.techno_list}': ['Refinery', 'FischerTropsch'],
                            ...
                            f'{self.name}.EnergyMix.fuel_production.liquid_fuel.Refinery.non_use_capital': non_use_capital_rf,
                            f'{self.name}.EnergyMix.fuel_production.liquid_fuel.FischerTropsch.non_use_capital': non_use_capital_ft,
                            ...
                            f'{self.name}.EnergyMix.fuel_production.liquid_fuel.Refinery.techno_capital': non_use_capital_rf,
                            f'{self.name}.EnergyMix.fuel_production.liquid_fuel.FischerTropsch.techno_capital': non_use_capital_ft,
