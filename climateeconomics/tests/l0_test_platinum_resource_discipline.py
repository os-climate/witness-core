...
class PlatinumModelTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.energy_platinum_demand_df = read_csv(
            join(data_dir, "all_demand_variable.csv")
        )  # all_demand_from_energy_mix.csv
        ...
        self.param = {
            "resources_demand": self.energy_platinum_demand_df,
    ...
    def test_platinum_discipline(self):
        ...
        inputs_dict = {
            ...
            f"{name}.{model_name}.resources_demand": self.energy_platinum_demand_df,
            "production_start": self.production_start,
        }
