...
class MacroeconomicsTestCase(unittest.TestCase):
    ...
    def test_macroeconomics_discipline(self):
        ...
        inputs_dict = {
            ...
            f"{name}.{GlossaryCore.SectorIndustry}.{GlossaryCore.DamageDfValue}": self.damage_indus[
                GlossaryCore.DamageDf["dataframe_descriptor"].keys()
            ],
            f"{name}.{GlossaryCore.SectorAgriculture}.{GlossaryCore.DamageDfValue}": self.damage_agri[
                GlossaryCore.DamageDf["dataframe_descriptor"].keys()
            ],
            f"{name}.{GlossaryCore.SectorServices}.{GlossaryCore.DamageDfValue}": self.damage_service[
                GlossaryCore.DamageDf["dataframe_descriptor"].keys()
            ],
            f"{name}.{GlossaryCore.SectorIndustry}.{GlossaryCore.DamageDetailedDfValue}": self.damage_indus[
                GlossaryCore.DamageDetailedDf["dataframe_descriptor"].keys()
            ],
            f"{name}.{GlossaryCore.SectorAgriculture}.{GlossaryCore.DamageDetailedDfValue}": self.damage_agri[
                GlossaryCore.DamageDetailedDf["dataframe_descriptor"].keys()
            ],
            f"{name}.{GlossaryCore.SectorServices}.{GlossaryCore.DamageDetailedDfValue}": self.damage_service[
                GlossaryCore.DamageDetailedDf["dataframe_descriptor"].keys()
            ],
