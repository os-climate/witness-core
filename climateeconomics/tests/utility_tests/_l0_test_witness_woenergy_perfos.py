...
class TestScatter(unittest.TestCase):
    ...
    def test_01_witness_perfos_execute(self):
        ...
        builder = self.ee.factory.get_builder_from_process(repo, "witness_wo_energy")
        ...
        energy_mean_price = pd.DataFrame({GlossaryCore.Years: self.years, GlossaryCore.EnergyPriceValue: energy_price})
        ...
        _convert_array_into_df_time = float(
            [line for line in lines if "_convert_array_into_df" in line][0].split(",")[3]
        )
        ...
        ax1.axis("equal")
        ax1.set_title(f"WITNESS wo energy {mda_class} with {n_processes} procs, Total time : {total_time} s")
        ...
        if platform.system() == "Windows":
            ...
            os.system(f"git add ./climateeconomics/tests/utility_tests/witness_wo_energy_perfos.csv")
