...
class TestScatter(unittest.TestCase):
    ...
    def test_01_witness_perfos_execute(self):
        ...
        if platform.system() == "Windows":
            ...
            os.system("git add ./climateeconomics/tests/utility_tests/witness_perfos.csv")
    ...
    def test_08_witness_full_mda_perfos_parallels(self):
        ...
        if platform.system() == "Windows":
            ...
            os.system("git add ./perfo_dir/*.csv")
            os.system("git add ./perfo_dir/*.jpg")
            os.system('git commit -m "Add perfo MDA parallel figures"')
            os.system("git pull")
            os.system("git push")
