...
class ForestTestCase(unittest.TestCase):
    ...
    def test_forest_discipline_high_lost_capital(self):
        ...
        self.forest_invest_df = pd.DataFrame(
            {GlossaryCore.Years: years,
             'forest_investment': np.array([262.3080913163442, 469.0288051740345, 646.7923512783858, 797.3169880002974,
                                            922.3209737106685, 1023.5225667803987, 1102.6400255803876,
                                            1161.3916084815337,
                                            1201.4955738547371, 1224.670180070897, 1232.6336855009129,
                                            1227.1043485156838,
                                            1209.8004274861094, 1182.4401807830886, 1146.7418667775214,
                                            1104.4237438403065,
                                            1057.2040703423438, 1006.5964839949823, 953.2961398713705,
                                            897.7935723851078,
                                            ...
                                            199.05102724978983, 164.0929896380927, 133.50800601069787,
                                            107.00387192417816,
                                            ...
                                            3.8911613193912378, 2.1242782531265565, 1.2239958500378234,
                                            0.8981096666978611,
                                            0.854415259679471, 0.849695588213618, 0.836683222163885, 0.8170981340520096,
                                            0.7926602963997317, 0.7650896817287889, 0.7361062625609198,
                                            0.707430011417863,
                                            0.680780900821357, 0.6578789032931407, 0.6404439913549522,
                                            0.6301961375285303,
                                            0.6288553143356134])})
        ...
        self.mw_invest_df = pd.DataFrame(
            {GlossaryCore.Years: years, GlossaryCore.InvestmentsValue: mw_invest})
        self.deforest_invest_df = pd.DataFrame(
            {GlossaryCore.Years: years, GlossaryCore.InvestmentsValue: np.array(
                [40.62218956750874, 40.56970502780573, 40.53622422620158, 40.52075010891646,
    ...
    def test_forest_discipline_low_lost_capital(self):
        ...
        self.forest_invest_df = pd.DataFrame(
            {GlossaryCore.Years: years,
             'forest_investment': np.array([26.3080913163442, 46.0288051740345, 64.7923512783858, 79.3169880002974,
                                            ...
                                            0.8911613193912378, 0.1242782531265565, 0.2239958500378234,
                                            0.8981096666978611,
                                            0.854415259679471, 0.849695588213618, 0.836683222163885, 0.8170981340520096,
                                            0.7926602963997317, 0.7650896817287889, 0.7361062625609198,
                                            0.707430011417863,
