...
class CoalModelTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.energy_coal_demand_df = read_csv(join(data_dir, "all_demand_from_energy_mix.csv"))
        ...
        self.param = {
            "resources_demand": self.energy_coal_demand_df,
    ...
    def test_coal_discipline(self):
        ...
        """
        name = "Test"
        model_name = "all_resource.coal_resource"
